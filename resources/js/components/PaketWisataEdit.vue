            ...
            <div class="col-md-12">
                <form v-if="success_get" @submit.prevent="save">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-8">
                            <ckeditor class="border" :editor="editor" v-model="data_res.harga1" :config="editorConfig"></ckeditor>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-4 card-caption-home">Harga Tidak Termasuk</div>
                        <div class="col-md-8">
                            <ckeditor class="border" :editor="editor" v-model="data_res.harga2" :config="editorConfig"></ckeditor>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-4 card-caption-home">Jadwal</div>
                        <div class="col-md-8">
                            <ckeditor class="border" :editor="editor" v-model="data_res.jadwal" :config="editorConfig"></ckeditor>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-4 card-caption-home">Itinerary</div>
                        <div class="col-md-8">
                            <ckeditor class="border" :editor="editor" v-model="data_res.itinerary" :config="editorConfig"></ckeditor>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-4 card-caption-home">Keterangan Tambahan</div>
                        <div class="col-md-8">
                            <ckeditor class="border" :editor="editor" v-model="data_res.tambahan" :config="editorConfig"></ckeditor>
                        </div>
                    </div>
