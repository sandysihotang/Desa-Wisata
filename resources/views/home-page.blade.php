        ...
        <q-carousel-slide name="first" img-src="/image/home/Tipang_Mas.jpg">
            <div class="absolute-bottom-right col-md-5 text-subtitle2 justify-content-center">
                <div class="float-right text-white">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p class="text-white">Restoran Terapung bernama tipang mas menyuguhkan lokasi tenang dengan
                                pemandangan danau dan jajaran perbukitan berlatar langit biru</p>
                        </div>
                    </div>
                </div>
            </div>
