                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="container">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-5 text-left">Role</div>
                                        <div class="col-md-7">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-5 text-left">Username</div>
                                        <div class="col-md-7">
                                            <input class="form-control" type="text"/>
                                        </div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-md-5 text-left">Password</div>
                                        <div class="col-md-7">
                                            <input class="form-control" type="password"/>
                                        </div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-md-5 text-left">Konfirmasi Password</div>
                                        <div class="col-md-7">
                                            <input class="form-control" type="password"/>
                                        </div>
                                    </div>
